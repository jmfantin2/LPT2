...
public class InternalMyDslParser extends AbstractInternalContentAssistParser {
    ...
    // InternalMyDsl.g:114:1: rule__Greeting__Group__0__Impl : ( '<' ) ;
    public final void rule__Greeting__Group__0__Impl() throws RecognitionException {
        ...
        try {
            ...
            {
             before(grammarAccess.getGreetingAccess().getLessThanSignKeyword_0()); 
            match(input,11,FOLLOW_2); 
             after(grammarAccess.getGreetingAccess().getLessThanSignKeyword_0()); 
    ...
    public final void rule__Greeting__Group__2__Impl() throws RecognitionException {
        ...
        try {
            ...
            {
             before(grammarAccess.getGreetingAccess().getGreaterThanSignKeyword_2()); 
            match(input,12,FOLLOW_2); 
             after(grammarAccess.getGreetingAccess().getGreaterThanSignKeyword_2()); 
